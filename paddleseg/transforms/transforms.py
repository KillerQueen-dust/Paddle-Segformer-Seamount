...
class Compose:
    ...
    def __init__(self, transforms, to_rgb=True, img_channels=3): 
        ...
        self.read_flag = cv2.IMREAD_UNCHANGED if img_channels == 1 else cv2.IMREAD_COLOR
    ...
    def __call__(self, data):
        ...
        if data['img'] is None:
            ...
            # logger.info(f"{data['img'].min(), data['img'].max()}")
...
class NormalizeUint16:
    ...
    def __call__(self, data):
        data['img'] = functional.normalize_uint16(data['img'], self.mean, self.std)
        return data
